...
def ficha(num, p, cred):
  ...
  <figure class="foto"><img src="../../assets/img/rio-de-janeiro/%(img)s.webp" alt="%(alt)s" width="1200" height="675" loading="lazy" decoding="async"><figcaption><p class="foto-cred">%(cred)s</p></figcaption></figure>%(nota)s%(botao)s
